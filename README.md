...
PS. Этот репозиторий является только примером реализации для реального выполнения такой задачи хватит фоновой таски селери (тут хайп драйвен девелопмент у меня)